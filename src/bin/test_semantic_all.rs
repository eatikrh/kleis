...
fn o(s: &str) -> Expression { Expression::Object(s.to_string()) }
fn op(name: &str, args: Vec<Expression>) -> Expression {
    Expression::Operation { name: name.to_string(), args }
}

fn main() {
    let tests = vec![
        ("Fraction", op("frac", vec![o("a"), o("b")])),
        ("Nested fraction", op("frac", vec![op("frac", vec![o("a"), o("b")]), o("c")])),
        ("Square root", op("sqrt", vec![o("x")])),
        ("Power", op("sup", vec![o("x"), o("2")])),
        ("Subscript", op("sub", vec![o("a"), o("n")])),
        ("Matrix 2x2", op("matrix2x2", vec![o("a"), o("b"), o("c"), o("d")])),
        ("Inner product", op("inner", vec![o("u"), o("v")])),
        ("Integral", op("int_bounds", vec![o("f(x)"), o("0"), o("1"), o("x")])),
        ("Sum", op("sum_bounds", vec![o("a_n"), o("n=1"), o("\\infty")])),
