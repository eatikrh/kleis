...
#align(center)[
  #text(size: 17pt, weight: "bold")[Flat Galactic Rotation Curves as a Theorem of Projected Ontology: Machine-Verified Derivations Without Dark Matter]
...
== From Slow Decay to Linear Mass Growth

The main results in Section 3 are proved from the velocity relation (A6) and the linear mass growth axiom (A8/A12). The reader may ask: what role does slow decay (A5) actually play?

A5 constrains which kernels are admissible. In the *boundary-saturating case* — equality in A5, so that $h(G, r) dot r = kappa$ for constant $kappa > 0$ — we showed in Section 2.3 that the resulting logarithmic potential produces exactly the linear mass growth of A8. The bridge is:

$ "A5 at saturation" arrow.r h(G,r) = kappa \/ r arrow.r Phi prop ln(r) arrow.r M_("proj")(r) = lambda r quad "(A8)" $

We verify two intermediate lemmas that make this chain explicit:

*Bridge Lemma 1.* If $h(G, r_2) dot r_2 >= h(G, r_1) dot r_1$ and $h(G, r_1) dot r_1 >= h(G, r_2) dot r_2$ (the equality case of A5), then $h(G, r_1) dot r_1 = h(G, r_2) dot r_2$. Z3 status: *VERIFIED* ✓

*Bridge Lemma 2.* From $M_("proj")(r) = lambda dot r$ (A8) and $v^2 dot r = M_("proj")(r)$ (A6) with $r > 0$, it follows that $v^2 = lambda$. Z3 status: *VERIFIED* ✓

Thus the logical chain is: A5 (slow decay) constrains the kernel → the saturating case yields a logarithmic potential (Section 2.3) → this produces linear mass growth (A8) → combined with the velocity relation (A6), velocity is flat. The formal theorems in Section 3 start from A6+A8 because these are the minimal algebraic premises; A5 provides the *physical justification* for why A8 holds.
...
Proof sketch: From A6, $M(r) = lambda r$. From the velocity relation, $v^2 r = M(r) = lambda r$. Since $r > 0$, we divide both sides by $r$ to obtain $v^2 = lambda$, a constant independent of $r$. (In the refined Theorem 2 below, the condition becomes $r >= R_c$; since $R_c > 0$ by Axiom A10, this implies $r > 0$, justifying the division.)
...
== Theorem 2: Inner-Outer Transition
...
== Theorem 3: The Baryonic Tully-Fisher Relation
...
#figure(
  ...
  lq.plot(
    ...
    (0.100000, 0.200000, 0.300000, 0.400000, 0.500000, 0.600000, 0.700000, 0.800000, 0.900000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000),
    color: blue,
    label: [POT (projected mass)]
  ),
  lq.plot(
    (0.100000, 0.200000, 0.300000, 0.400000, 0.500000, 0.600000, 0.700000, 0.800000, 0.900000, 1.000000, 1.100000, 1.200000, 1.300000, 1.400000, 1.500000, 1.600000, 1.700000, 1.800000, 1.900000, 2.000000, 2.100000, 2.200000, 2.300000, 2.400000, 2.500000, 2.600000, 2.700000, 2.800000, 2.900000, 3.000000, 3.100000, 3.200000, 3.300000, 3.400000, 3.500000, 3.600000, 3.700000, 3.800000, 3.900000, 4.000000, 4.100000, 4.200000, 4.300000, 4.400000, 4.500000, 4.600000, 4.700000, 4.800000, 4.900000, 5.000000, 5.100000, 5.200000, 5.300000, 5.400000, 5.500000, 5.600000, 5.700000, 5.800000, 5.900000, 6.000000),
    (0.100000, 0.200000, 0.300000, 0.400000, 0.500000, 0.600000, 0.700000, 0.800000, 0.900000, 1.000000, 0.953463, 0.912871, 0.877058, 0.845154, 0.816497, 0.790569, 0.766965, 0.745356, 0.725476, 0.707107, 0.690066, 0.674200, 0.659380, 0.645497, 0.632456, 0.620174, 0.608581, 0.597614, 0.587220, 0.577350, 0.567962, 0.559017, 0.550482, 0.542326, 0.534522, 0.527046, 0.519875, 0.512989, 0.506370, 0.500000, 0.493865, 0.487950, 0.482243, 0.476731, 0.471405, 0.466252, 0.461266, 0.456435, 0.451754, 0.447214, 0.442807, 0.438529, 0.434372, 0.430331, 0.426401, 0.422577, 0.418854, 0.415227, 0.411693, 0.408248),
, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000, 1.000000),
    color: red,
    label: [Newton: baryonic mass only]
  ),
)
,
  caption: [Normalized effective gravitational mass as a function of $xi = r \/ R_c$. In POT (blue), the projected mass grows linearly beyond the core — not because there are more stars at large radii, but because the kernel's logarithmic coherence amplifies the gravitational contribution of the finite baryonic core. In Newtonian gravity (red), the effective mass equals the baryonic mass and saturates at $M_b$. This divergence is the origin of flat rotation curves.]
) <fig:mass>
...
#figure(
  ...
  caption: [Dimensionless orbital velocities at selected radii. POT and Newtonian predictions agree for $xi <= 1$ and diverge for $xi > 1$. The ratio $v_("POT") \/ v_("Newton")$ grows as $sqrt(xi)$, confirming the universal character of flat rotation curves.]
) <tab:velocities>
...
The formal verification infrastructure was built using Kleis (https://kleis.io) with Z3 as the backend SMT solver. The author thanks the Kleis AI assistant for collaborative theory development and proof checking during the formalization sessions.

#heading(numbering: none)[References]
#set text(size: 9pt)
#par(hanging-indent: 1.5em)[\[rubin1980\] Rubin, V. C., Ford, W. K., & Thonnard, N. (1980). Rotational properties of 21 SC galaxies with a large range of luminosities and radii. ApJ, 238, 471-487.]

#par(hanging-indent: 1.5em)[\[milgrom1983\] Milgrom, M. (1983). A modification of the Newtonian dynamics as a possible alternative to the hidden mass hypothesis. ApJ, 270, 365-370.]

#par(hanging-indent: 1.5em)[\[mcgaugh2016\] McGaugh, S., Lelli, F., & Schombert, J. (2016). Radial Acceleration Relation in Rotationally Supported Galaxies. Physical Review Letters, 117, 201101.]

#par(hanging-indent: 1.5em)[\[lelli2017\] Lelli, F., McGaugh, S. S., & Schombert, J. M. (2017). The baryonic Tully-Fisher relation. ApJ, 836, 152.]

#par(hanging-indent: 1.5em)[\[moura2008\] de Moura, L., & Bjorner, N. (2008). Z3: An efficient SMT solver. TACAS 2008.]

#par(hanging-indent: 1.5em)[\[clowe2006\] Clowe, D., et al. (2006). A Direct Empirical Proof of the Existence of Dark Matter. ApJ, 648, L109-L113.]

#par(hanging-indent: 1.5em)[\[nfw1997\] Navarro, J. F., Frenk, C. S., & White, S. D. M. (1997). A Universal Density Profile from Hierarchical Clustering. ApJ, 490, 493-508.]

#par(hanging-indent: 1.5em)[\[ciotti2022\] Ciotti, L., Mancino, A., & Pellegrini, S. (2022). On the rotation curve of disk galaxies in General Relativity. arXiv:2207.09736.]
...
*A6.* `velocity_from_mass`: $forall(G, f, r). "adm"(G) and r > 0 ==> v^2(G,f,r) dot r = M_("proj")(G,f,r)$ \
*A7.* `projected_mass_nonneg`: $forall(G, f, r). "adm"(G) ==> M_("proj")(G,f,r) >= 0$ \
*A8.* `linear_growth`: $forall(G, f, r). "adm"(G) and r > 0 ==> M_("proj")(G,f,r) = lambda(G,f) dot r$ \
*A9.* `positive_rate`: $forall(G, f). "adm"(G) ==> lambda(G,f) > 0$ \
*A10.* `core_positive`: $forall(G, f). "adm"(G) ==> R_c (G,f) > 0$ \
*A11.* `inner_newtonian`: $forall(G, f, r). "adm"(G) and 0 < r < R_c (G,f) ==> M_("proj")(G,f,r) > lambda(G,f) dot r$ \
*A12.* `outer_flat`: $forall(G, f, r). "adm"(G) and r >= R_c (G,f) ==> M_("proj")(G,f,r) = lambda(G,f) dot r$ \
*A13.* `baryonic_from_core`: $forall(G, f). "adm"(G) ==> M_b (G,f) = lambda(G,f) dot R_c (G,f)$ \
*A14.* `core_scales`: $forall(G, f). "adm"(G) ==> R_c (G,f) = a dot v^2(G, f, R_c (G,f))$
]
#set text(size: 10pt)
