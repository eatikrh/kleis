...
- `TODO(2024-12-06)` comment with date
- Can be found with: `grep -r "TODO.*2024-12-06" src/`
...
grep -r "TODO(2024-12-06)" src/
```

### Expected Output
```
src/math_layout/typst_adapter.rs:    // TODO(2024-12-06): Placeholder conversion tests...
...
src/render.rs:    // TODO(2024-12-06): Some LaTeX rendering tests...
