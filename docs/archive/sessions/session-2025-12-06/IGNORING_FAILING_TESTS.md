...
```rust
#[test]
#[ignore] // TODO(2025-12-06): Fix placeholder conversion in typst_adapter
fn test_convert_placeholder() {
    // Test code...
}
```
...
```rust
#[test]
#[ignore = "TODO(2025-12-06): Placeholder conversion broken - needs typst_adapter refactor"]
fn test_convert_placeholder() {
    // ... test code ...
}
```
...
mod tests {
    ...
    // TODO(2025-12-06): These placeholder tests fail due to typst_adapter changes
...
#[cfg(test)]
mod tests {
    // TODO(2025-12-06): Some LaTeX rendering tests have outdated expectations
...
2. Add date stamps: `TODO(2025-12-06)`
