...
This release focuses on completing pattern matching with three powerful features:

### 1. Pattern Guards

Guards allow conditional matching beyond simple structural patterns:
