// Kleis.g4 v0.6 - ANTLR4 Grammar for Kleis with Functions in Structures
// Date: 2024-12-12 (Updated to sync with EBNF v0.6)
// NEW: Functions in Structures (derived operations)
...
//   - Aligns grammar with prelude.kleis usage
//
